...
\begin{tikzpicture}[
    ...
    mbox/.style={rectangle, rounded corners=2pt, draw=gray!40, fill=gray!3,
        minimum width=3.4cm, minimum height=1.2cm, align=center, font=\scriptsize},
    rbox/.style={rectangle, rounded corners=2pt, draw=purple!60!black, fill=purple!4,
        minimum width=3.4cm, minimum height=0.55cm, align=center, font=\fontsize{6}{7}\selectfont\bfseries},
